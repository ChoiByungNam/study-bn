...
var fx = function() {
    ...
    function I(b, d, c) {
        b = t(b);
        1 == arguments.length ? d = c = b : (d = t(d),
        c = t(c));
    ...
    (function() {
        function a(b) {
            if (!b.getExtension("OES_texture_float"))
                return !1;
    ...
    var h = function() {
                ...
                if (b.hasOwnProperty(e)) {
                    ...
                    if (null !== c) {
                        ...
                        if ("[object Array]" == Object.prototype.toString.call(d))
                            ...
                            throw 'attempted to set uniform "' + e + '" to invalid value ' + (d || "undefined").toString();
                    }
                }
            return this
        }
        ...
        d.prototype.drawRect = function(b, c, e, d) {
            ...
            null == a.texCoordBuffer && (a.texCoordBuffer = a.createBuffer(),
